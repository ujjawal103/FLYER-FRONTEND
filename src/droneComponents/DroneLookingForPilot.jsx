...
const DroneLookingForPilot = ({setVehicalFound , pickup , destination , finalFair}) => {
  return (
     <div>
       <h2 className='text-xl font-medium'>Looking For The Drone</h2>
...
export default DroneLookingForPilot
