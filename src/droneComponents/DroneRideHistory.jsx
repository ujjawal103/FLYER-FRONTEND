...
import DroneFooterNav from '../droneComponents/DroneFooterNav';
import { useNavigate } from "react-router-dom";

export default function DroneRideHistory() {
  ...
  useEffect(() => {
    if (selectedRide) {
      navigate("/drone-home", { state: { ride: selectedRide } });
    }
  }, [selectedRide]);
  ...
  return (
    <>
      ...
      <div className="p-4 mb-50">
        <h2 className="text-xl font-bold mb-4">My Products & rides </h2>
