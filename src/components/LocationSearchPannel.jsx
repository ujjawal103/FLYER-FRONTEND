...
const LocationSearchPannel = ({pannel , setPannel , vehiclePannel , setVehicalPannel , suggestedLocation , setSuggestedLocation , setPickup , setDestination ,pickup , destination ,  pickupOrDestination , setUnavailableLocation ,fair , setFair , error , setError}) => {
  const [isSearching , setIsSearching] = useState("Search Aircraft");
     ...
     setIsSearching("Searching...");
      try{
          ...
          if (responseGetFair.status === 200) {
              ...
              setIsSearching("Search Aircraft");
          }
      }catch (err){
