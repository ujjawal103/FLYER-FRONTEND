...
const ConfirmRide = ({setConfirmRidePannel , setVehicalFound , pickup , destination , finalFair , createRide , setLoading , setMessage}) => {
    
  return (
    <div>
       <h2 className='text-xl font-medium'>Confirm your ride</h2>
        ...
        <div className='flex justify-center items-center flex-col gap-3'>
            ...
            <button onClick={() => {setConfirmRidePannel(false); createRide(); setLoading(true); setMessage("Creating ride...");}} className='w-full bg-green-700 text-white p-2 font-semibold rounded'>Confirm</button>
        </div>
    </div>
  )
}
