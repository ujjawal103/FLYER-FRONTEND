...
const RidePopUpToPilot = ({setRidePopupPannel , setConfirmRidePopupPannel , ride , rideBy , rideConfirm , setLoading , setMessage}) => {
  return (
    <div>
       <h2 className='text-xl font-medium'>New Ride For You</h2>
...
export default RidePopUpToPilot
